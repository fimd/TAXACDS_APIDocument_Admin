# Admin API - Đếm tổng số thông báo thuế

Đếm tổng số thông báo thuế trong hệ thống.

## Endpoint

- URL: /TaxCDSTaxNotification/countTotalNotifications
- Method: POST
...
```bash
curl --location 'http://127.0.0.1:4001/TaxCDSTaxNotification/countTotalNotifications' \
