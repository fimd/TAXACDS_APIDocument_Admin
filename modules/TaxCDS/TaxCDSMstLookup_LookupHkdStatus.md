...
| filter.taxCode | string | No | Có thể rỗng | Mã số thuế hộ kinh doanh cần tra cứu. |
| filter.citizenIdentityNumber | string | No | Có thể rỗng | Số CCCD/CMND của chủ hộ kinh doanh. |
| filter.taxpayerName | string | No | Có thể rỗng, hỗ trợ tìm gần đúng | Tên hộ kinh doanh hoặc tên người nộp thuế. |
